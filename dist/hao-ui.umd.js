(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('lodash-es'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', 'lodash-es', 'axios'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["hao-ui"] = {}, global.Vue, global._, global.axios));
})(this, (function (exports, vue, lodashEs, axios) { 'use strict';
  ...
  const textStylesProps = lodashEs.without(Object.keys(textDefaultProps), 'actionTypes', 'text', 'url');
  const imageStylesProps = lodashEs.without(Object.keys(imageDefaultProps), 'src');
  const buttonStylesProps = lodashEs.without(Object.keys(imageDefaultProps), 'plain', 'round', 'type', 'actionTypes');
  const transformToComponentProps = (props) => {
      return {
          ...lodashEs.mapValues(props, item => {
              return {
  ...
  var script$2 = /*#__PURE__*/ vue.defineComponent({
      ...
      setup(__props) {
          ...
          return (_ctx, _cache) => {
              return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.tagCustomName), {
  ...
  const _withScopeId = n => (vue.pushScopeId("data-v-59dfe29a"),n=n(),vue.popScopeId(),n);
  const _hoisted_1 = { class: "file-uploader" };
  const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("button", { disabled: "" }, "正在上传", -1 /* HOISTED */));
  const _hoisted_3 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("button", null, "点击上传", -1 /* HOISTED */));
  const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/vue.createElementVNode("button", null, "点击上传", -1 /* HOISTED */));
  const _hoisted_5 = {
    key: 0,
    class: "file-list"
  };
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
      vue.createElementVNode("div", vue.mergeProps({ class: "uploader-area" }, vue.toHandlers(_ctx.events, true), {
        ...
        (_ctx.isUploading)
          ...
          : (_ctx.lastFileData && _ctx.lastFileData.loaded)
            ? vue.renderSlot(_ctx.$slots, "uploaded", {
                key: 1,
      ...
      (_ctx.showList)
        ? (vue.openBlock(), vue.createElementBlock("ul", _hoisted_5, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.filesList, (item, index) => {
              return (vue.openBlock(), vue.createElementBlock("li", {
                key: index,
                class: vue.normalizeClass(_ctx.uploadStatusClass(item.status))
              }, [
  ...
  exports.HButton = script;
  exports.LText = script$2;
  exports.LUploader = script$1;
  exports.buttonDefaultProps = buttonDefaultProps;
  exports.buttonStylesProps = buttonStylesProps;
  exports.commonDefaultProps = commonDefaultProps;
  exports.default = index;
  exports.imageDefaultProps = imageDefaultProps;
  exports.imageStylesProps = imageStylesProps;
  exports.install = install;
  exports.isEditingProp = isEditingProp;
  exports.textDefaultProps = textDefaultProps;
  exports.textStylesProps = textStylesProps;
  exports.transformToComponentProps = transformToComponentProps;
